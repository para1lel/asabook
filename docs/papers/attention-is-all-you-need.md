...
|卷积|$O(k\cdot n\cdot d^{2})$|$O(1)$|$O(\mathrm{log}_{k}(n))$|
...
|深度注意 位置未知 集成 [CoRRd16]||40.4|||$8.0\cdot 10^{20}$|
|GNMT RL Ensemble [Xivh16]|26.30|41.16||$1.8\cdot 10^{20}$|$1.1\cdot 10^{21}$|
|ConvS2S 集成 [Xiv17]|26.36|41.29||$7.7\cdot 10^{19}$|$1.2\cdot 10^{21}$|
...
||$N$|$d_{\mathrm{model}}$|$d_{\mathrm{ff}}$|$h$|$d_{k}$|$d_{v}$|$P_{\mathrm{drop}}$|$\epsilon_{\mathrm{ls}}$|训练|PPL (困惑度)|BLEU|参数|
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
||步数| (开发集)| (开发集)|$\times 10^{6}$|||||||||
...
|||4096|||||||4.75|26.2|90||
| (D)|||||||0.0|||5.77|24.6||
|||||||0.2 ZX0013QXZ 0.74|||4.95|25.5|||
||||||||0.0||4.67|25.3|||
||||||||0.2 ZX0013QXZ 0.74||5.47|25.7|||
| (E)||使用位置嵌入而非正弦函数||||||||4.92|25.7||
|大|6|1024|4096|16|||0.3||30 万|4.33|26.4|213|
...
|解析器|训练|WSJ 23 F1|
| --- | --- | --- |
|Vinyals & Kaiser 等 (2014) [System15]|仅 WSJ, 判别式|88.3|
|Petrov 等 (2006) [July06]|仅 WSJ, 判别式|90.4|
|Zhu 等 (2013) [August13]|仅 WSJ, 判别式|90.4|
|Dyer 等 (2016) [NAACL16]|仅 WSJ, 判别式|91.7|
|Transformer (4 层)|仅 WSJ, 判别式|91.3|
|Zhu 等 (2013) [August13]|半监督|91.3|
|Huang & Harper (2009) [PCFG09]|半监督|91.3|
|McClosky 等 (2006) [June06]|半监督|92.1|
|Vinyals & Kaiser 等 (2014) [System15]|半监督|92.1|
|Transformer (4 层)|半监督|92.7|
|Luong 等 (2015) [Xivc15]|多任务|93.0|
|Dyer 等 (2016) [NAACL16]|生成式|93.3|
