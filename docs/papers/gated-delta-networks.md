...
> Songlin Yang, Jan Kautz, and Ali Hatamizadeh. 首次提交至 arXiv: December 9, 2024; 当前版本为 v3. [Gated Delta Networks: Improving Mamba2 with Delta Rule](https://arxiv.org/abs/2412.06464). [原始 PDF](/paper/gated-delta-networks.pdf). [TeX 源码](https://export.arxiv.org/e-print/2412.06464). 精确的印刷版式和参考文献以原始 PDF 为准.
