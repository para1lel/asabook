...
> [Songlin Yang](https://dblp.org/pid/03/7764), [Jan Kautz](https://dblp.org/pid/48/6214), and [Ali Hatamizadeh](https://dblp.org/pid/226/7000). 首次提交至 arXiv: December 9, 2024; 当前版本为 v3. [Gated Delta Networks: Improving Mamba2 with Delta Rule](https://arxiv.org/abs/2412.06464). [原始 PDF](/paper/gated-delta-networks.pdf). [TeX 源码](https://export.arxiv.org/e-print/2412.06464). 精确的印刷版式和参考文献以原始 PDF 为准.
...
|曼巴 2|$\|{\mathbf{S}}_{t}-\alpha_{t}{\mathbf{S}}_{t-1}\|_{F}^{2}-2\langle{\mathbf{S}}_{t}{\bm{k}}_{t},{\bm{v}}_{t}\rangle$|${\mathbf{S}}_{t}=\alpha_{t}{\mathbf{S}}_{t-1}+{\bm{v}}_{t}{\bm{k}}_{t}^\top$|
|长角牛|$\|{\mathbf{S}}_{t}-{\mathbf{S}}_{t-1}\|_{F}^{2}-\beta_{t}\|{\mathbf{S}}_{t}{\bm{k}}_{t}-{\bm{v}}_{t}\|^{2}$|${\mathbf{S}}_{t}={\mathbf{S}}_{t-1}({\mathbf{I}}-\epsilon{\bm{k}}_{t}{\bm{k}}_{t}^\top)+\epsilon_{t}{\bm{v}}_{t}{\bm{k}}_{t}^\top,\epsilon_{t}=\frac{\beta_{t}}{1+\beta_{t}{\bm{k}}_{t}^{\top}{\bm{k}}_{t}}$|
...
|门控 DeltaNet|$\|{\mathbf{S}}_{t}-\alpha_{t}{\mathbf{S}}_{t-1}\|_{F}^{2}-2\langle{\mathbf{S}}_{t}{\bm{k}}_{t},\beta_{t}\left({\bm{v}}_{t}-\alpha_{t}{\mathbf{S}}_{t-1}{\bm{k}}_{t}\right)\rangle$|${\mathbf{S}}_{t}={\mathbf{S}}_{t-1}\left(\alpha_{t}({\mathbf{I}}-\beta_{t}{\bm{k}}_{t}{\bm{k}}_{t}^\top)\right)+\beta_{t}{\bm{v}}_{t}{\bm{k}}_{t}^\top$|
...
|模型|维基百科|LMB|LMB|PIQA|Hella|Wino|ARC-e|ARC-c|SIQA|BoolQ|平均值|
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
|循环车型||||||||||||
|回转网|19.08|17.27|40.52|70.07|49.16|54.14|67.34|33.78|40.78|60.39|52.02|
|HGRN2|19.10|17.69|39.54|70.45|49.53|52.80|69.40|35.32|40.63|56.66|51.79|
|曼巴|17.92|15.06|43.98|71.32|52.91|52.95|69.52|35.40|37.76|61.13|53.12|
|曼巴 2|16.56|12.56|45.66|71.87|55.67|55.24|72.47|37.88|40.20|60.13|54.89|
|DeltaNet|17.71|16.88|42.46|70.72|50.93|53.35|68.47|35.66|40.22|55.29|52.14|
|门控 DeltaNet|16: 42|12.17|46.65|72.25|55.76|57.45|71.21|38.39|40.63|60.24|55.32|
|注意力或混合模型||||||||||||
...
|门控 DeltaNet-H1|16.07|12.12|47.73|72.57|56.53|58.40|71.75|40.10|41.40|63.21|56.40|
|门控 DeltaNet-H2|15.91|12.55|48.76|72.19|56.88|57.77|71.33|39.07|41.91|61.55|56.18|
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
||| (密码检索)|||| (干草堆中的数字)|||| (干草堆中的单词)|||
|模型||1K|2K|4K|8K|1K|2K|4K|8K|1K|2K|4K|
|DeltaNet||97.4|96.8|99.0|98.8|98.4|45.6|18.6|14.4|85.2|47.0|22.4|
|曼巴 2||99.2|98.8|65.4|30.4|99.4|98.8|56.2|17.0|64.4|47.6|4.6|
|门控 DeltaNet||98.4|88.4|91.4|91.8|100.0|99.8|92.2|29.6|86.6|84.2|27.6|
...
|模型|SWDE|SQD|FDA|TQA|NQ|Drop|平均|
| --- | --- | --- | --- | --- | --- | --- | --- |
|循环车型||||||||
|回转网|14.0|28.5|7.0|54.4|16.2|17.3|22.9|
|HGRN2|8.3|25.3|4.8|51.2|14.2|16.9|20.1|
|曼巴|9.8|25.8|3.7|54.3|14.9|17.4|21.0|
|曼巴 2|19.1|33.6|25.3|61.0|20.8|19.2|29.8|
|DeltaNet|17.9|30.9|18.4|53.9|17.3|18.6|26.2|
|门控 DeltaNet|25.4|34.8|23.7|60.0|20.0|19.8|30.6|
|注意力或混合模型||||||||
|Transformer|29.5|38.0|52.2|58.3|22.5|21.6|37.0|
|Samba|33.0|39.2|50.5|57.7|23.5|20.2|37.3|
|门控 DeltaNet-H1|35.6|39.7|52.0|60.1|24.6|22.2|39.0|
|门控 DeltaNet-H2|38.2|40.4|50.7|63.3|24.8|23.3|40.1|
...
||单文档问答|||多文档问答|||摘要|||少量样本|||代码||平均|
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
|模型|NQA|质量保证协会|MFQ|总部|2WM|Mus|GvR|QMS|MNs (明尼苏达州)|TRC|TQA|SSM|LCC|RBP||
|循环车型||||||||||||||||
|回转网|12.1|10.7|19.1|10.7|18.0|5.8|4.8|15.8|7.9|19.0|18.0|12.8|14.1|17.9|13.2|
|HGRN2|10.7|12.1|19.1|11.3|15.7|6.0|5.2|15.1|9.2|16.0|15.8|10.3|18.6|20.8|13.5|
|曼巴|13.0|10.1|20.4|10.1|16.7|6.0|7.2|15.9|8.4|23.1|21.9|11.2|17.9|19.0|14.6|
|DeltaNet|12.9|10.8|21.5|10.9|13.2|5.1|6.5|13.5|7.2|15.5|23.3|11.6|17.6|20.3|13.6|
|曼巴 2|11.1|11.3|18.6|11.8|15.1|6.7|6.7|14.5|7.4|13.0|23.6|8.4|17.9|20.6|13.5|
|门控 DeltaNet|14.1|14.0|23.3|13.7|14.4|5.8|7.5|16.4|7.9|30.0|22.4|23.0|18.7|22.1|16.6|
|注意力或混合模型||||||||||||||||
...
|门控 DeltaNet-H1|14.5|12.3|26.6|12.6|23.6|6.1|9.1|16.1|12.8|33.5|23.9|26.8|15.5|19.2|17.8|
|门控 DeltaNet-H2|12.7|13.0|27.1|12.7|20.6|7.5|10.4|16.2|13.0|40.5|22.7|27.9|19.9|22.1|18.4|
...
|Gated DeltaNet 消融实验 (400M)|平均困惑度 (Avg-PPL) (${\downarrow}$)|平均准确率 (Avg-Acc) (${\uparrow}$)|
| --- | --- | --- |
|Gated DeltaNet, 头维度 128,|27.35|47.26|
|*宏设计*|||
|使用简单 Delta 规则|30.87|45.12|
|不使用短卷积|28.95|46.16|
|不使用输出门|29.12|45.46|
|不使用输出归一化|27.55|47.07|
|*归一化与特征图*|||
|使用 $L_{1}$ 归一化 & ReLU|30.79|45.92|
|使用 $L_{1}$ 归一化 & 1 个 ELU|30.34|46.05|
|使用 $L_{1}$ 归一化 & SiLU|30.18|46.09|
|使用 $L_{2}$ 归一化 & ReLU|27.67|46.94|
|使用 $L_{2}$ 归一化 & 1 个 ELU|27.58|47.17|
|*模型维度*|||
|使用头维度 64|28.31|46.35|
|使用头维度 256|27.13|47.38|
...
||ppl $\downarrow$|ppl $\downarrow$|acc $\uparrow$|acc $\uparrow$|acc_n $\uparrow$|acc $\uparrow$|acc $\uparrow$|acc_n $\uparrow$|acc $\uparrow$|acc $\uparrow$||
|混合消融 (500M/15B)||||||||||||
|门控 DeltaNet SWA Mamba2|24.02|28.20|34.77|67.08|40.84|50.74|60.35|28.83|38.94|61.49|47.88|
|门控 DeltaNet Mamba2 SWA|23.69|26.83|36.17|67.51|41.51|51.85|61.19|29.77|38.58|53.73|47.54|
|Mamba2 SWA 门控 DeltaNet|24.14|25.21|36.79|64.96|41.18|52.01|60.90|30.03|38.07|59.44|47.92|
|Mamba2 门控 DeltaNet SWA|23.54|24.11|36.92|66.48|41.70|52.72|61.06|30.54|39.91|60.51|48.73|
