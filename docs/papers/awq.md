...
基于转换器的大型语言模型 (LLMs) [Vas17] 在各种基准测试中表现出色 [Bro20c, Zha22a, Tou23, Les23]. 然而, 模型体积大导致服务成本高. 例如, GPT-3 有 1750 亿参数, 以 FP16 存储时为 350GB, 而最新的 H100 GPU 内存仅为 96GB, 更不用说边缘设备了.
