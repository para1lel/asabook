---
title: "Buffers and Memory"
createTime: 2026/08/01 00:00:00
permalink: /en/gpupro/buffers-and-memory/
...
first — see [Data Types and Expressions](/en/gpupro/data-types-and-expressions/).
...
| `layout` | physical mapping ([TileLayout](/en/gpupro/tirx-layout-api/)); `"default"` = dense row-major |
...
The TMEM pool ([Tensor memory](#tensor-memory), below) is layered on top of an `SMEMPool`.
...
transfer (see also [Data Types and Expressions](/en/gpupro/data-types-and-expressions/)):
