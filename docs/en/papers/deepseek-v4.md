...
**Agent.** Agent datasets include Terminal Bench 2.0 [Mer26], SWE-Verified [Ope24e], SWE Multilingual [Yan25b], SWE-Pro [Den25], BrowseComp [Wei25], the public evaluation set of MCPAtlas [Ban26a], GDPval-AA [Pat25, Aa25], and Tool-Decathlon [Li25b].
