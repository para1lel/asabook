...
We evaluate GPipe performance with two very different types of model architectures: an AmoebaNet [Xiva18] convolutional model and a Transformer [Neuria17] sequence-to-sequence model. We ran experiments to study their scalability, efficiency and communication cost.
