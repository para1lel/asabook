...
permalink: /en/yokubi/part-1/lesson-12/
...
It is worth noting there are other ways to make orders and imperative commands in Japanese. The て(ください) form is a rather weak and fairly soft order. It's closer to a polite request rather than a straight up command. 
