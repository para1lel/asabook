...
permalink: /en/yokubi/part-3/lesson-30/
pageClass: yokubi-page
---
There are two basic types of relative clause. The first is the kind that modifies a noun, which we already learned in [Lesson 14](../part-1/lesson-14.md). The second is an embedded clause, often called a "quote", like the underlined part of "He said that <ins>the war would end soon</ins>".
